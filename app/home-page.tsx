...
export default function Home() {
  return (
    <div className="bg-white bg-opacity-75 rounded-xl p-5 mb-5">
      <h1 className="font-bold text-40 text-center text-green-900 mb-5">
      ...
      <p className={`${inter.className} text-base  text-green-900 mb-5`}>
        ...
        Pirkkalan Linnakallioon sekä siihen nojaavat massiiviset kuntien
